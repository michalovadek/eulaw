...
iplot_votes_prop <- country_votes_prop |> 
  ...
  theme(legend.position = "top",
        ...
        axis.title = element_text(hjust = 1, size = 14),
        plot.subtitle = element_text(face = "italic", size = 15),
        plot.caption = element_text(face = "italic", size = 8.2),
        strip.text = element_text(hjust = 0, face = "bold")) +
...
In the future this page should include information on: most common Treaty legal bases (after applying equivalence table), relatedly distribution of directory codes, legal basis Treaty chapters, analysis of effect of voting rule change, and more.
