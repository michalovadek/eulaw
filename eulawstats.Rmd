...
Controlling for the type of act, the linear model predicts that for every additional Member State, the EU takes ```r effect``` days longer to adopt the legal act. This effect is ```r ifelse(reject_null == "can reject", "statistically significant", "not statistically significant")``` at ```r p_thresh``` alpha.
