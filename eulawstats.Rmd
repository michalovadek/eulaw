...
in_force |> 
  ...
  labs(x = NULL,
       ...
       subtitle = "Histogram of the number of days since a currently applicable act entered into force")
...
At the same time, there is seemingly meaningful variation among the different types of acts. Directives suffer the least from the "recency bias", while regulations and decisions tend to have comparatively short lifespans.
